<template>
  <section class="py-12 md:py-16">
    <div class="container">
      ...
      <!-- Verify License Link -->
      <div v-if="verifyLink" class="mt-6 text-center">
        <a
          :href="verifyLink"
          target="_blank"
  ...
  tabs: () => [
    {
      ...
      image: '/images/docs/accreditation.webp'
    },
    {
      name: 'Лицензия',
      ...
      image: '/images/docs/license.webp'
    },
    {
      name: 'Свидетельство',
      ...
      image: '/images/docs/certificate.webp'
    },
    {
      ...
      image: '/images/docs/tractor-license.webp'
    }
  ],
